...
function checkGroceryCount(){
    ...
    if(groceryCount >= 5) return "That looks like a big trip";
    else if(groceryCount > 1 && groceryCount < 5) return `${groceryCount} items`;
    else if(groceryCount <= 1) return "1 item";
}
//////////////////STEP 6////////////////////
