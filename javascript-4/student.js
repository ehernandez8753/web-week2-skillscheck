...
superPowers:["flight", "telekinesis", "control electricity"], 
...
function setColor(arr){
    if(arr.length > 3) arr.splice(2, arr.length);
...
// Next, create a for loop to loop over the array. If any of the colors you chose is 'blue', change it's value to '#4D4DFF' which is just a more appealing color of blue. 
//Outside of the for loop but still inside of setColor, invoke the function called background which will take in three arguments. These arguments should be each item of your array. 
